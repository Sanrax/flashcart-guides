...
1. You will need the `usrcheat.dat` file from the download link in the post. Copy this file to `__ezds/cheats/` on your SD card. (Create the `cheats` folder if it doesn't exist)
