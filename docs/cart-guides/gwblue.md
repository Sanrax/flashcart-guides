...
=== "Pico-Launcher"
    ...
    1. Download the latest [Pico Package for Gateway Blue.](https://files.deletecat.com/pico-builds/pico_package_GWBLUE.zip?picoloader={{pico_versions.loader}}&picolauncher={{pico_versions.launcher}}&fcnetrev={{pico_versions.fcnetrev}})
