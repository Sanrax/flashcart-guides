...
=== "Pico-Launcher"
    ...
    1. Download the latest [Pico Package for M3i Zero GMP-Z003.](https://files.deletecat.com/pico-builds/pico_package_G003.zip?picoloader={{pico_versions.loader}}&picolauncher={{pico_versions.launcher}}&fcnetrev={{pico_versions.fcnetrev}})
