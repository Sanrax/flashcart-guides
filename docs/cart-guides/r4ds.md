...
=== "Pico-Launcher"
    ...
    1. Download the latest [Pico Package for Original R4.](https://files.deletecat.com/pico-builds/pico_package_R4.zip?picoloader={{pico_versions.loader}}&picolauncher={{pico_versions.launcher}}&fcnetrev={{pico_versions.fcnetrev}})
