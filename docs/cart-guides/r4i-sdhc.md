...
=== "Pico-Launcher"
    ...
    1. Download the latest [Pico Package for DSTT.](https://files.deletecat.com/pico-builds/pico_package_DSTT.zip?picoloader={{pico_versions.loader}}&picolauncher={{pico_versions.launcher}}&fcnetrev={{pico_versions.fcnetrev}})
