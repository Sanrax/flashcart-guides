---
title: DS Family Battery Guide
---

![Battery](../images/battery/header_image.jpg){ align=right width="115"}
...
=== "Original DS (Phat)"
    ...
    - Any battery that looks like this or similar:
        ...
        ![Fake DS Phat Battery](../images/battery/fakephat.png){ align=left width="215"}
    ...
    ***Why avoid batteries that meet this criteria?*** Community reports have found that many do not meet their rated capacity, sometimes being as low as 200 to 300 mAh, leading to poor battery life. They can also provide unstable voltage, causing low battery warnings even when fully charged. Their fire safety and reliability are also questionable and should not be trusted.
    ...
    - Cameron Sino CS-NTR003SL 850mAh Battery
        ...
        ![CS Original DS Battery](../images/battery/csntr.png){width="215"}

    - Cellonic Nintendo DS Battery 850mAh

        ![Cellonic Original DS Battery](../images/battery/cellonicntr.png){width="215"}
    ...
    - FunnyPlaying MaxPlay 950mAh LiPo Battery for GBA SP
        ...
        ![FunnyPlaying GBA SP Battery](../images/battery/funnyplayinggba.png){width="215"}

    - Helder MegaBat800 800mAh battery for GBA SP

        ![Helder GBA SP Battery](../images/battery/heldergba.png){width="215"}
...
=== "DS Lite"
    ...
    ***Why avoid batteries that meet this criteria?*** Community reports have found that many do not meet their rated capacity, sometimes being as low as 200 to 300 mAh, leading to poor battery life. They can also provide unstable voltage, causing low battery warnings even when fully charged. Their fire safety and reliability are also questionable and should not be trusted.
    ...
    - Cameron Sino CS-USG003SL 850mAh Battery
        ...
        ![CS DS Lite Battery](../images/battery/csdsl.png){width="215"}

    - Helder MegaBat800 800mAh battery for NDS LITE

        ![Helder NDS LITE Battery](../images/battery/helderdsl.png){width="215"}
...
=== "DSi"
    ...
    ***Why avoid batteries that meet this criteria?*** Community reports have found that many do not meet their rated capacity, sometimes being as low as 200 to 300 mAh, leading to poor battery life. They can also provide unstable voltage, causing low battery warnings even when fully charged. Their fire safety and reliability are also questionable and should not be trusted.
    ...
    - Cameron Sino CS-TWL003SL 550mAh Battery
        ...
        ![CS DSI Battery](../images/battery/csdsi.png){width="215"}
...
=== "DSi XL"
    ...
    - Any battery that looks like this or similar:
        ...
        ![Fake DSi Battery 1](../images/battery/fakedsixl1.png){ align=left width="215"}
    ...
    ***Why avoid batteries that meet this criteria?*** Community reports have found that many do not meet their rated capacity, sometimes being as low as 200 to 300 mAh, leading to poor battery life. They can also provide unstable voltage, causing low battery warnings even when fully charged. Their fire safety and reliability are also questionable and should not be trusted.
    ...
    - Cellonic Nintendo DSi XL Battery 900mAh
        ...
        ![Cellonic DSi XL Battery](../images/battery/cellonicxl.png){width="215"}

    - Cameron Sino CS-UTL003SL 900mAh Battery

        ![CS DSi XL Battery](../images/battery/csxl.png){width="215"}
